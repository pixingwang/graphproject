...
@Service
public class MapUtilForEmbeddedDriver {

	public Map<String, Object> map(Node c){
		Map<String, Object> result = new HashMap<String, Object>();
	
		result=c.getAllProperties();
		
		List<Label> nodeLabel=new ArrayList<>();
		Iterator<Label> labels=c.getLabels().iterator();
	...
	public Map<String, Object> map(String key1, Object value1, String key2, Object value2,Relationship r) {
		...
		result=r.getAllProperties();
		result.put(key1, value1);
		result.put(key2, value2);
		
		result.put("label",r.getType().name());
